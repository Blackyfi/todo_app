...
extension AndroidNotificationChannelMapper on AndroidNotificationChannel {
  Map<String, Object?> toMap() => <String, Object?>{
        ...
        'ledColorAlpha': ledColor != null ? (ledColor!.a * 255.0).round() & 0xff : null,
        'ledColorRed': ledColor != null ? (ledColor!.r * 255.0).round() & 0xff : null,
        'ledColorGreen': ledColor != null ? (ledColor!.g * 255.0).round() & 0xff : null,
        'ledColorBlue': ledColor != null ? (ledColor!.b * 255.0).round() & 0xff : null,
        'channelAction':
...
extension AndroidNotificationDetailsMapper on AndroidNotificationDetails {
  Map<String, Object?> toMap() => <String, Object?>{
        ...
        'ongoing': ongoing,
        'silent': silent,
        'colorAlpha': color != null ? (color!.a * 255.0).round() & 0xff : null,
        'colorRed': color != null ? (color!.r * 255.0).round() & 0xff : null,
        'colorGreen': color != null ? (color!.g * 255.0).round() & 0xff : null,
        'colorBlue': color != null ? (color!.b * 255.0).round() & 0xff : null,
      ...
      'actions': actions
          .map(
            (AndroidNotificationAction e) => <String, dynamic>{
              'id': e.id,
              'title': e.title,
              'titleColorAlpha': e.titleColor != null ? (e.titleColor!.a * 255.0).round() & 0xff : null,
              'titleColorRed': e.titleColor != null ? (e.titleColor!.r * 255.0).round() & 0xff : null,
              'titleColorGreen': e.titleColor != null ? (e.titleColor!.g * 255.0).round() & 0xff : null,
              'titleColorBlue': e.titleColor != null ? (e.titleColor!.b * 255.0).round() & 0xff : null,
